...
namespace DentistDatabase
{
    public partial class 患者建档 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)//取消并返回
        {
            this.Close();
            主界面 main = new 主界面();
            main.Show();
        ...
        private void button1_Click(object sender, EventArgs e)//建档并返回
        {
        ...
        private void button3_Click(object sender, EventArgs e)//建档并编辑档案
        {
            String name = textName.Text.Trim();
            int sex = 1;
            DateTime birth = textBirth.Value;
