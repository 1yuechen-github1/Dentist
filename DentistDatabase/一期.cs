...
namespace DentistDatabase
{
    public partial class 一期 : Form
    {
        ...
        {
            String sqlText = @"SELECT  [牙位-患者表].种植牙位, 一期信息.就诊记录, 一期信息.手术日期, 一期信息.骨质类型, 一期信息.牙龈厚度, 一期信息.种植体品牌, 一期信息.种植体型号, 一期信息.种植体直径, 一期信息.种植体长度, 一期信息.植入扭矩, 一期信息.愈合方式, 一期信息.覆盖螺丝尺寸, 一期信息.愈合基台型号, 愈合基台表.愈合基台直径, 愈合基台表.愈合基台高度, 一期信息.是否植骨, 一期信息.植骨术式, 一期信息.植骨量, 一期信息.植骨材料品牌, 一期信息.是否使用屏障膜, 一期信息.屏障膜长度, 一期信息.屏障膜宽度, 一期信息.屏障膜品牌, 一期信息.伤口愈合情况, 一期信息.是否做即刻修复, 一期信息.是否做数字化导板, 一期信息.导板制作公司, 
                   ...
                   一期信息.[1期CBCT], 一期信息.[1期小牙片], 一期信息.[1期全景片], 一期信息.[1期手术视频], 
                   一期信息.[临床照片（多张）] " +
                ...
                else if (dr.RowState == System.Data.DataRowState.Modified) //修改
                {
                    strSQL = @"UPDATE[一期信息]
                               SET [就诊记录] = '" + dr["就诊记录"].ToString() + @"'
                                  ...
                                  ,[1期CBCT] = '" + dr["1期CBCT"].ToString() + @"'
                                  ,[1期小牙片] = '" + dr["1期小牙片"].ToString() + @"'
                                  ,[1期全景片] = '" + dr["1期全景片"].ToString() + @"'
                                  ,[1期手术视频] = '" + dr["1期手术视频"].ToString() + @"'
